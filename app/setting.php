...
$GLOBALS['setting_contents'] = [
    ...
    'menu' => [
        'menu_entry' => [
            'name'        => '公開ページのメニューに「エントリー」を表示',
            'explanation' => null,
            'type'        => 'boolean',
            'required'    => false,
        ],
        'menu_contact' => [
            'name'        => '公開ページのメニューに「お問い合わせ」を表示',
            'explanation' => null,
            'type'        => 'boolean',
            'required'    => false,
        ],
        'menu_auth_contact' => [
            'name'        => '認証ページのメニューに「お問い合わせ」を表示',
            'explanation' => null,
            'type'        => 'boolean',
            'required'    => false,
        ],
        'menu_auth_comment' => [
            'name'        => '認証ページのメニューに「コメント」を表示',
            'explanation' => null,
            'type'        => 'boolean',
            'required'    => false,
        ],
        'menu_auth' => [
            'name'        => '公開ページのメニューに「ログイン」を表示',
            'explanation' => null,
            'type'        => 'boolean',
            'required'    => false,
        ],
        'menu_admin_field' => [
            'name'        => '管理ページのメニューに「フィールド」を表示',
            'explanation' => null,
            'type'        => 'boolean',
            'required'    => false,
        ],
        'menu_admin_menu' => [
            'name'        => '管理ページのメニューに「メニュー」を表示',
            'explanation' => null,
            'type'        => 'boolean',
            'required'    => false,
        ],
        'menu_admin_widget' => [
            'name'        => '管理ページのメニューに「ウィジェット」を表示',
            'explanation' => null,
            'type'        => 'boolean',
            'required'    => false,
        ],
