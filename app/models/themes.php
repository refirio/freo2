 ...
 * @return array
 */
function select_themes($queries, $options = [])
{
    $queries = db_placeholder($queries);

    // テーマを取得
    $queries['from'] = DATABASE_PREFIX . 'themes';
 ...
 * @return resource
 */
function insert_themes($queries, $options = [])
{
    $queries = db_placeholder($queries);

    // 初期値を取得
    $defaults = model('default_themes');
    ...
    // データを登録
    $queries['insert_into'] = DATABASE_PREFIX . 'themes';
 ...
 * @return resource
 */
function update_themes($queries, $options = [])
{
    $queries = db_placeholder($queries);
    ...
    // データを編集
    $queries['update'] = DATABASE_PREFIX . 'themes';
 ...
 * @return resource
 */
function delete_themes($queries, $options = [])
{
    $queries = db_placeholder($queries);
    $options = [
    ...
    if ($options['softdelete'] === true) {
        // データを編集
        $resource = db_update([
            'update' => DATABASE_PREFIX . 'themes AS themes',
            'set'    => [
 ...
 * @return array
 */
function validate_themes($queries, $options = [])
{
    $options = [
