...
$_view['contacts'] = model('select_contacts', [
    ...
    'limit'    => [
        ':offset, :limit',
        [
            'offset' => $GLOBALS['config']['limit']['admin_contact'] * ($_GET['page'] - 1),
            'limit'  => $GLOBALS['config']['limit']['admin_contact'],
        ],
    ],
], [
    'associate' => true,
...
$_view['contact_page']  = ceil($contact_count[0]['count'] / $GLOBALS['config']['limit']['admin_contact']);
