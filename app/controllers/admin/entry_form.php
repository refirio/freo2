...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($_GET['id'])) {
        ...
        $_view['entry']['code']      = $GLOBALS['setting']['entry_default_code'] ? localdate($GLOBALS['setting']['entry_default_code']) : '';
        $_view['entry']['text_type'] = $GLOBALS['setting']['entry_text_type'];
    } else {
