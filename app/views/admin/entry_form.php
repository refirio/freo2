                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 mb-2 px-md-4">
                    ...
                    <div class="card shadow-sm mb-3">
                        ...
                        <?php else : ?>
                            ...
                            <form action="<?php t(MAIN_FILE) ?>/admin/entry_form<?php $_view['entry']['id'] ? t('?id=' . $_view['entry']['id']) : '' ?>" method="post" class="register validate">
                                ...
                                <div class="card shadow-sm mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-2">
                                            <label class="fw-bold">本文<?php if ($GLOBALS['authority']['power'] >= 3) : ?>（<a href="#" data-bs-toggle="modal" data-bs-target="#mediaModal">メディア</a>）<?php endif ?></label>
                            ...
                            <?php if ($GLOBALS['setting']['entry_use_approve'] && $GLOBALS['authority']['power'] >= 3) : ?>
