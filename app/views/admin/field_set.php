                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <div id="validate_field_sets_<?php t($field['id']) ?>">
                                                ...
                                                <div class="field upload" id="field_<?php t($_view[$field['target']]['id'] . '_' . $field['id']) ?>" data-upload="<?php t(MAIN_FILE) ?>/admin/file_upload?_type=json&amp;target=field&amp;key=field_<?php t($_view[$field['target']]['id'] . '_' . $field['id']) ?>&amp;format=<?php t($field['type']) ?>">
                                                    ...
                                                    <p><img src="<?php t(MAIN_FILE) ?>/admin/file?_type=file&amp;target=field&amp;key=field_<?php t($_view[$field['target']]['id'] . '_' . $field['id']) ?>&amp;format=<?php t($field['type']) ?><?php $_view['entry']['id'] ? t('&id=' . $_view['entry']['id']) : '' ?>"></p>
                                                    <ul>
                                                        <li><a href="<?php t(MAIN_FILE) ?>/admin/file_delete?target=field&amp;key=field_<?php t($_view[$field['target']]['id'] . '_' . $field['id']) ?>&amp;format=<?php t($field['type']) ?><?php $_view['entry']['id'] ? t('&id=' . $_view['entry']['id']) : '' ?>" id="field_<?php t($_view[$field['target']]['id'] . '_' . $field['id']) ?>_delete" class="token" data-token="<?php t($_view['token']) ?>">削除</a></li>
                                                    </ul>
                                                </div>
                                                <?php endif ?>
                                            </div>
