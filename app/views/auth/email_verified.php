<?php import('app/views/auth/header.php') ?>
    ...
    <main class="col-11 col-md-7 mx-auto my-4">
        <div class="mb-4 text-center">
            <h1 class="h3">
                <a href="<?php t(MAIN_FILE) ?>/auth/home"><?php h($GLOBALS['string']['heading_register']) ?></a>
            </h1>
        </div>
        ...
        <div class="card shadow-sm mb-3">
            ...
            <div class="card-body">
                ...
                <p><a href="<?php t(MAIN_FILE) ?>/auth/" class="btn btn-secondary"><?php h($GLOBALS['string']['text_goto_auth_home']) ?></a><p>
            </div>
        </div>
