...
<html>
    <head>
        ...
        <title><?php isset($_view['title']) ? h($_view['title'] . ' | ') : '' ?><?php h(preg_match('/^(index|register|password)(_|$)/', $_REQUEST['_work']) ? '' : $GLOBALS['string']['heading_mypage'] . ' | ') ?><?php h($GLOBALS['setting']['title']) ?></title>
        <?php e($_view['widget_sets']['auth_initial']) ?>
