    ...
    <div id="comment">
        ...
        <form action="<?php t(MAIN_FILE) ?>/comment/preview" method="post">
            ...
            <div class="form-group mt-4">
                <a href="<?php t(MAIN_FILE) ?><?php t($_view['entry']['type_code'] === 'page' ? '/page/' : '/' . $_view['entry']['type_code'] . '/detail/') ?><?php t($_view['entry']['code']) ?>?referer=preview#comment_form" class="btn btn-secondary px-4"><?php h($GLOBALS['string']['button_comment_back']) ?></a>
